<div class="site-bar overlay-bottombar-default <?php echo ( get_theme_mod( 'overlay-bottombar-switch', customizer_library_get_default( 'overlay-bottombar-switch' ) ) ) ? sanitize_html_class( 'site-bottombar-switch' ) : ''; ?>">
    <div class="site-container">
        ...
        <div class="site-bar-inner">
            <div class="site-bar-left">
                ...
                printf( esc_html__( 'Theme:&nbsp;%1$s&nbsp;by&nbsp;%2$s.&nbsp;', 'overlay' ), esc_html__( 'Overlay', 'overlay' ), wp_kses( __( '<a href="https://kairaweb.com/" class="no-margin">Kaira</a>', 'overlay' ), array( 'a' => array( 'href' => array(), 'class' => array() ) ) ) ); ?>
            ...
            <div class="site-bar-right <?php echo 1 == get_theme_mod( 'overlay-add-botbar-fullcart', customizer_library_get_default( 'overlay-add-botbar-fullcart' ) ) ? sanitize_html_class( 'overlay-bottombar-fullcart' ) : sanitize_html_class( 'overlay-bottombar-nofullcart' ); ?>">
                ...
                <?php if ( 'footer-social-two' == get_theme_mod( 'overlay-footer-layout', customizer_library_get_default( 'overlay-footer-layout' ) ) && !get_theme_mod( 'overlay-remove-botbar-extratxt', customizer_library_get_default( 'overlay-remove-botbar-extratxt' ) ) ) : ?>
