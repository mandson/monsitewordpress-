<div class="site-bar overlay-bottombar-one <?php echo ( get_theme_mod( 'overlay-bottombar-switch', customizer_library_get_default( 'overlay-bottombar-switch' ) ) ) ? sanitize_html_class( 'site-bottombar-switch' ) : ''; ?>">
    <div class="site-container">
        ...
        <div class="site-bar-inner">
            ...
            <div class="site-bar-right <?php echo 1 == get_theme_mod( 'overlay-add-botbar-fullcart', customizer_library_get_default( 'overlay-add-botbar-nofullcart' ) ) ? sanitize_html_class( 'overlay-bottombar-fullcart' ) : sanitize_html_class( 'overlay-bottombar-fullcart' ); ?>">
