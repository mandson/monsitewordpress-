<div class="site-bar overlay-topbar-two <?php echo ( get_theme_mod( 'overlay-topbar-switch', customizer_library_get_default( 'overlay-topbar-switch' ) ) ) ? sanitize_html_class( 'site-topbar-switch' ) : ''; ?> <?php echo ( 'stick-onlytbar' == get_theme_mod( 'overlay-stick-header-element', customizer_library_get_default( 'overlay-stick-header-element' ) ) ) ? sanitize_html_class( 'stick-header' ) : ''; ?>">
